    ...
    const box = el("section", {class: "login"}, [
        ...
        el("form", {
            ...
            el("label", {}, [
                el("span", {}, "Server URL"),
                el("input", {
                    id: "srv", type: "url", required: true,
                    placeholder: "http://66.225.151.13:8742",
                    value: Api.getServer() || "",
            ...
            el("p", {class: "login-foot"},
                "A token will be stored on this device. Sessions last 30 days."),
        ]),
    ]);
